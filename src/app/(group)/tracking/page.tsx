...
function TrackShipment() {
  ...
  useEffect(() => {
    const fetchTrackingData = async () => {
      if (queryLabelId) {
        ...
        try {
          ...
          router.replace(`/tracking?labelId=${queryLabelId}`); // Update URL
          const response = await axios.get(`/api/shipengine/tracking/${queryLabelId}`);
    ...
    fetchTrackingData(); // Call the inner function
  }, [queryLabelId, router]);
