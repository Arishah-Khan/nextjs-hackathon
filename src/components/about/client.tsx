...
export default function Client() {
  ...
  return (
    <section>
          <div className="text-center md:text-start pb-4 pt-4 md:pt-10 md:px-10">
          <h4
          ...
          <h2
            className="text-black font-bold pt-1 sm:pt-4 pb-6 sm:pb-10 font-[Helvetica] text-lg sm:text-2xl lg:text-4xl mt-2"
            style={{ fontFamily: "Helvetica" }}
          >
            What our clients are saying
          </h2>
        </div>
      <div className="flex flex-col items-center space-y-8 py-4 sm:py-8 px-4 sm:px-8">
          ...
          <div className="relative bg-white p-6 sm:p-8 rounded-lg shadow-lg w-full max-w-lg">
            ...
            <div className="absolute -top-12 left-1/2 transform -translate-x-1/2  sm:w-28 sm:h-28 rounded-full overflow-hidden bg-black border-4 border-[#FF9F0D]">
              <Image
                ...
                width="20"
                height="20"
                className=" w-[80px] h-[80px] sm:w-[100px] sm:h-auto object-contain"
              />
            </div>

            <div className="flex flex-col items-center space-y-2 sm:space-y-4 mt-10">
              <div>
                <Image
