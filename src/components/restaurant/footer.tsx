      ...
      <div className="container max-w-[1000px] mx-auto flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="flex flex-row justify-center items-center md:items-end md:w-1/2 md:space-y-4">
          <input
            ...
            className="px-2 py-2 sm:py-3 sm:px-4 text-sm sm:text-lg bg-[#FF9F0D] text-white placeholder-white"
          />
          <button className="bg-white text-[#FF9F0D] px-2 py-2 text-sm sm:text-lg sm:py-3 sm:px-6 flex items-center">
